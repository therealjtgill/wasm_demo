...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '../../bin/editor.data';
      var REMOTE_PACKAGE_BASE = 'editor.data';
...
Module['FS_createPath']("/", "glsl_es_shaders", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_../../bin/editor.data');

      };
      Module['addRunDependency']('datafile_../../bin/editor.data');
